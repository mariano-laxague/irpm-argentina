...
| P5.4 | Formalizar release | Checklist y changelog | Release incluye código, docs, datos, tests y evidencia UX | 🟡 Implementado 14/08 — pendiente completar la evidencia antes de etiquetar |
| P5.5 | Ensayar recuperación | Restore desde backup | Simulación documentada recupera DB y dashboard | 🟡 Implementado 14/08 — falta registrar un ensayo operativo con backup real |
...
| P6.2 | Recuperar controles analíticos necesarios | Dashboard | Período accesible; una única serie pública evita modos que contradicen el valor vigente | ✅ Completado 14/08 — selector temporal y serie IRPM única; diagnóstico VIX fuera de la interfaz pública |
...
| P6.6 | Ejecutar QA visual | Capturas desktop/mobile | Todos los journeys y estados clave inspeccionados antes de publicar | ✅ Completado 14/08 — J1, J2 y J3 revisados con límites documentados |
